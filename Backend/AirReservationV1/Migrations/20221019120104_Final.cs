    ...
    public partial class Final : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "FlightId", "Destination", "Duration", "FlightName", "LandingTime", "NumberOfSeats", "Price", "Source", "TakeOffTime" },
                values: new object[] { 1, "Delhi", 2f, "Air India", new DateTime(2022, 10, 19, 19, 31, 4, 112, DateTimeKind.Local).AddTicks(4106), 95, 3999, "Mumbai", new DateTime(2022, 10, 19, 17, 31, 4, 112, DateTimeKind.Local).AddTicks(4097) });
